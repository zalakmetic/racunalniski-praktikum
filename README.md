...
- *kopiraj* označeno v odložišče: Ctrl+C (**C**opy) <br> 
- *Izreži* označeno v odložišče: Ctrl+X <br>
- *Prilepi* vsebino odložišča: Ctrl+V <br>
- premikanje po odprtih aplikacijah: Cmd+tab <br>
- nova datoteka (VSC): Cmd+N <br>
- zapiranje programa: Cmd+shift+W <br>
<!-- 2. nivojski razdelek -->
## Izvorna koda
...
## Povezava do spletne strani iz 5. domače naloge
[Moja spletna stran](https://zalakmetic.github.io/)
